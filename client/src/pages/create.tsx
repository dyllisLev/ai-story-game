  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/stories", {
        ...
        body: JSON.stringify({
          ...formData,
          description: formData.description || "새로운 스토리",
          author: "User",
          image: formData.image || "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=1000",
        }),
      });
