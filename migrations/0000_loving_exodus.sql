...
CREATE TABLE "sessions" (
	...
	"conversation_profile_name" text,
	"user_note" text,
	"summary_memory" text,
...
ALTER TABLE "api_logs" ADD CONSTRAINT "api_logs_session_id_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."sessions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
